cve_all_data_1 = {'resultsPerPage': 1, 'startIndex': 0, 'totalResults': 1, 'format': 'NVD_CVE',
        ...
        'metrics': {'cvssMetricV31': [{'source': 'nvd@nist.gov', 'type': 'Primary',
                                       'cvssData': {'version': '3.1',
                                                    ...
                                                    'scope': 'UNCHANGED', 'confidentialityImpact': 'NONE',
                                                    'integrityImpact': 'NONE', 'availabilityImpact': 'HIGH',
                                                    'baseScore': 7.5, 'baseSeverity': 'HIGH'},
                                       'exploitabilityScore': 3.9, 'impactScore': 3.6}], 'cvssMetricV2': [
            {'source': 'nvd@nist.gov', 'type': 'Primary',
             'cvssData': {'version': '2.0', 'vectorString': 'AV:N/AC:L/Au:N/C:N/I:N/A:P',
                          'accessVector': 'NETWORK', 'accessComplexity': 'LOW', 'authentication': 'NONE',
                          'confidentialityImpact': 'NONE', 'integrityImpact': 'NONE',
                          'availabilityImpact': 'PARTIAL', 'baseScore': 5.0}, 'baseSeverity': 'MEDIUM',
             'exploitabilityScore': 10.0, 'impactScore': 2.9, 'acInsufInfo': False, 'obtainAllPrivilege': False,
        ...
        'weaknesses': [
            ...
            {'source': 'josh@bress.net', 'type': 'Secondary',
             'description': [{'lang': 'en', 'value': 'CWE-120'}]}], 'configurations': [{'nodes': [
            {'operator': 'OR', 'negate': False, 'cpeMatch': [{'vulnerable': True,
